package net.squirrel.httpsplugin;
...
import net.squirrel.httpsplugin.models.HttpRequest;
import net.squirrel.httpsplugin.models.HttpResponse;
import net.squirrel.httpsplugin.utils.HttpUtil;
import net.squirrel.httpsplugin.utils.JsonUtil;
...
public class HttpsPluginModule extends ReactContextBaseJavaModule {
    ...
    public HttpsPluginModule(ReactApplicationContext reactContext) {
        super(reactContext);
